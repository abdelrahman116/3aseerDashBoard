...
export default function ParistaComp() {
  let Notification = 5;
  return (
    <>
      <div className="Departs">
        <div className="mainName">راعي مسابقة باريستا الجنوب ☰</div>
        <div className="first flex flex-row-reverse justify-between">
          <h1>الأقسام الحالية</h1>
          <AddButton label="إضافة قسم" />
        </div>
        <div className="Sponser">
          <div className="flex flex-row ml-50 justify-around gap-120 mt-5">
            <div className="bg-white px-2 rounded-xl"> </div>

            <p className="block font-medium font-3xl"> شعارات </p>
          </div>
