  ...
  return (
    <>
      <div className="Departs ">
        <div className="mainName">ادارة الرعاة والمشاركين ☰</div>
        ...
        <div className="Sponser">
          <div className="flex flex-row  justify-around gap-120 mt-5">
            <div className="bg-gray-300 px-2 rounded-xl">
              شعارات {Notification}
            </div>
            <p className="block font-medium font-3xl"> الراعي الرسمي</p>
          </div>
        ...
        <div className="Sponser">
          <div className="flex flex-row justify-around gap-120 mt-5">
            ...
            <p className="block font-medium"> راعي الضيافة</p>
          </div>
          <div className="SponserShip mt-5 flex-row-reverse flex justify-around max-w-200">
            <div className="spon">
              <img className="w-25 h-15 rounded-xl" src={Dash3} alt="" />
